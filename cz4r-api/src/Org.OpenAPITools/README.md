...
additionalProperties:
  packageGuid: '{EC67D1E7-0A35-4A0E-950C-AE1CED0E6650}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IChangeWorkerApiApiResponse apiResponse = await api.ChangeWorkerApiAsync("todo");
            WorkerChangeOutput? model = apiResponse.Ok();
        }
